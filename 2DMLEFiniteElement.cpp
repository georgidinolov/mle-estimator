...
#pragma omp for
    for (i=0; i<N; ++i) {
      ...
      double x_0 = (data[i].get_x_0() - data[i].get_a())/Lx;
      double y_0 = (data[i].get_y_0() - data[i].get_c())/Ly;

      double x_T = (data[i].get_x_T() - data[i].get_a())/Lx;
      double y_T = (data[i].get_y_T() - data[i].get_c())/Ly;

      double sigma_x_star = sigma_x/Lx;
      double sigma_y_star = sigma_y/Ly;
      ...
      // b -> -b
      if (std::signbit(rho)) {
	x_0 = (-data[i].get_x_0() - -1.0*data[i].get_b())/Lx;
	x_T = (-data[i].get_x_T() - -1.0*data[i].get_b())/Lx;
